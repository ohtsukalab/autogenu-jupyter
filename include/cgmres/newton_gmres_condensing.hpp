#ifndef NEWTON_GMRES_CONDENSING_HPP_
#define NEWTON_GMRES_CONDENSING_HPP_
...
public:
  ...
  NewtonGMRESCondensing(const NLP& nlp, const Scalar finite_difference_epsilon) 
    : nlp_(nlp), 
...
#endif // NEWTON_GMRES_CONDENSING_HPP_