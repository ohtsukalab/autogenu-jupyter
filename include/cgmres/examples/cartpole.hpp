#ifndef CARTPOLE_HPP_
#define CARTPOLE_HPP_
...
public:
  ...
  inline void eval_f(const double t, const double* x, const double* u, double* dx) const {
    double x0 = sin(x[1]);
  ...
  inline void eval_phix(const double t, const double* x, double* phix) const {
  ...
  inline void eval_hx(const double t, const double* x, const double* u, 
  ...
  inline void eval_hu(const double t, const double* x, const double* u, 
