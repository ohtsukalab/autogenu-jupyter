...
namespace nmpcsim{
    ...
    void simulation(ContinuationGMRES nmpc_solver, const Eigen::VectorXd& initial_state_vec, const double start_time, const double end_time, const double sampling_period, const std::string savefile_name);
};
