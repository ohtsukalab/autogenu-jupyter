...
# Usage
First, set the parameters of your model of NMPC in nmpc_model.hpp, write equations in nmpc_model.cpp, and set simulation conditions in main.cpp. If you use MultipleShootingWithSaturation, which is a class for condensing the saturation on the control input, you have to set saturation conditions additionally. After that, build files as follows:
